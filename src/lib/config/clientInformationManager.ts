            ...
            const response = await fetch(
                `${this.baseUrl}/api/database/rows/table/${this.clientInfoTableId}/?user_field_names=true`,
                {
                    ...
                    body: JSON.stringify({
                        ...
                        'Founded Year': clientInfo.foundedYear || null,
                        'Website URL': clientInfo.websiteUrl || '',
                        'Blog URL': clientInfo.blogUrl || '',
                        'Facebook URL': clientInfo.facebookUrl || '',
                        'Instagram Handle': clientInfo.instagramHandle || '',
                        'LinkedIn URL': clientInfo.linkedinUrl || '',
                        'X Handle': clientInfo.xHandle || '',
                        'TikTok Handle': clientInfo.tiktokHandle || '',
                        'Country': clientInfo.country || '',
                        'City': clientInfo.city || '',
                        'Timezone': clientInfo.timezone || 'UTC',
                        'Primary Contact Name': clientInfo.primaryContactName || '',
                        'Primary Contact Email': clientInfo.primaryContactEmail || '',
                        'Primary Contact Phone': clientInfo.primaryContactPhone || '',
                        'Target Audience': clientInfo.targetAudience || '',
                        'Main Competitors': clientInfo.mainCompetitors || '',
                        'Business Goals': clientInfo.businessGoals || '',
                        'Brand Voice': clientInfo.brandVoice || '',
                        'Posting Frequency': clientInfo.postingFrequency || '',
                        ...
                        'Monthly Budget': clientInfo.monthlyBudget || null,
                    }),
                }
            )
